...
# ---------------------------------------------------------------------------------------
#set output './production/XiEtaMaxW.eps'

set title "Xi und Eta mit der maximalen Auslenkung" 
...
splot $DataInterpolated u 1:2:5 w pm3d palette notitle, \
