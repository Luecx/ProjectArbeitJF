...
\begin{equation}
\begin{multlined}
	w(x,y) = \frac{4}{\rho h a b \pi^4 \overline{a}^2} \cdot \left[ P_{1} \sum_m \sum_n \frac{\sin \left( \dfrac{m \pi x}{a} \right)^2 \cdot \sin \left( \dfrac{n \pi x}{b} \right)^2}{ \left( \frac{m^2}{a^2} + \frac{n^2}{b^2} \right)^2} \cdot \left( \cos(\overline{\theta-1}) - \cos(\overline{\theta}) \right) + \right. \\ P_{2} \sum_m \sum_n \frac{\sin \left( \dfrac{m \pi x}{a} \right)^2 \cdot \sin \left( \dfrac{n \pi x}{b} \right)^2}{ \left( \frac{m^2}{a^2} + \frac{n^2}{b^2} \right)^2} \cdot \left( \cos(\overline{\theta-2}) - \cos(\overline{\theta-1}) \right) + . \; . \; .\ \\ \left. + P_{\theta} \sum_m \sum_n \frac{\sin \left( \dfrac{m \pi x}{a} \right)^2 \cdot \sin \left( \dfrac{n \pi x}{b} \right)^2}{ \left( \frac{m^2}{a^2} + \frac{n^2}{b^2} \right)^2} \cdot \left( 1 - \cos(\overline{1}) \right) \right]
\end{multlined}
\end{equation}

In Kurzschreibweise also mit $(i=1,2 ... \theta)$ 

\begin{equation}
 	w(x,y) = \frac{4}{\rho h a b \pi^4 \overline{a}^2} \sum_i \sum_m \sum_n P_{i} \frac{\sin \left( \dfrac{m \pi x}{a} \right)^2 \cdot \sin \left( \dfrac{n \pi x}{b} \right)^2}{ \left( \frac{m^2}{a^2} + \frac{n^2}{b^2} \right)^2} \left( \cos(\overline{\theta - i}) - \cos(\overline{\theta - (i-1)}) \right)
\end{equation}
...
Setzt man $\tau$ in die (2.34) und (2.34) dann in die Doppelsumme aus (2.35) ein, folgt leicht

\begin{equation}
	\overline{S(k)} = \sum_m \sum_n \frac{\sin \left( \dfrac{m \pi x}{a} \right)^2 \cdot \sin \left( \dfrac{n \pi x}{b} \right)^2}{ \left( \frac{m^2}{a^2} + \frac{n^2}{b^2} \right)^2} \cdot \cos \left[ \left( \frac{m^2}{a^2}+\frac{n^2}{b^2} \right) \frac{\pi k}{90} \cdot \frac{a^{2}b^{2}}{a^{2}+b^{2}} \cdot (\theta - i)  \right] 
\end{equation}
