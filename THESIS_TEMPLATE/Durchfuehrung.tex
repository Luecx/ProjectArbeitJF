...
Die Gleichung für die Hertz'sche Pressung eines Kugel-Kugel-Punktkontaktes lautet nach\\ Jacobs~\cite{Jacobs.2019} wie in Gleichung~\ref{form:ZvonP}.
...
Hier ist $\frac{E}{(1 - \nu^{2})}$ der reduzierte E-Modul, welcher nach Jacobs~\cite{Jacobs.2019} durch Gleichung~\ref{form:redE} beschrieben wird.
...
Es ist ersichtlich, dass bei einem Massenverhältnis $MR \geq 1.7$ und einer Plattendicke von $h \geq 1.6 cm$ nur noch einzelne Stöße auftreten. Hier ist anzunehmen, dass der elastische Stoßvorgang der Kugel ausreichend kinetische Energie entgegen der Stoßrichtung überträgt, sodass die Kugel sich schneller entfernt als die Platte auslenken kann. \\
