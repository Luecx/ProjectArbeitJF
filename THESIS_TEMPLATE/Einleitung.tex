...
\begin{equation}
	M_{1} \ddot{x_{1}} + \lambda n \cdot \bigl| (x_{1} - x_{2}) \bigl| ^{\frac{3}{2}} = 0
\end{equation}

für die Stoßmasse und

\begin{equation}
	M_{p} \ddot{x_{2}} + K_{Biege} x_{2} + K_{Deform} x_{2}^{3} - \lambda n \cdot \bigl| (x_{1} - x_{2}) \bigl| ^\frac{3}{2} = 0
\end{equation}
...
\begin{equation}
	M_{pmax} = m \pi \cdot min\{(\frac{D_{22}}{D_{11}})^{\frac{1}{4}} r_{xmin}^{2} \; , \; (\frac{D_{11}}{D_{22}})^{\frac{1}{4}} r_{ymin}^{2} \}
\end{equation}		
