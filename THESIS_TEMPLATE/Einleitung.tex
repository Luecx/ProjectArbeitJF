...
und die Gleichung für die größte Plattenmasse $M_{p,max}$, die von Grenzen unbeeinflusst bleibt. Diese findet man, indem man die kleinere der beiden elliptischen Flächen die durch:
...
\begin{figure}[h!]
	\begin{center}
		\begin{overpic}[width=\linewidth]{pictures/einleitung/MindlinPlate.eps}
			\put(10,25){\begin{minipage}[t]{\textwidth}Eigentliche\\ Normaledeformation\end{minipage}}
			\put(73,7){\begin{minipage}[t]{\textwidth}Angenommene\\ Normaledeformation\end{minipage}}
		\end{overpic}
...
Es ist offensichtlich, dass vor allem im Bereich der isotropen Platten noch Forschungsbedarf herrscht. In dieser Arbeit wird auf dieses Thema weiter eingegangen.\\
